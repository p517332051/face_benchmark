...
if __name__ == '__main__':
    ...
    flag = "train"
    if flag == "train":
        data_root = r'/data2/M30_fr_train' #/data/liyue/data/msra_align_112*96
        # # data_dest = '/data2/futuretown/compare'
        file_list = r'/data2/M30_fr_train.txt'
        get_img_file(data_root, file_list, folder_depth=3)
        # get_img_list(data_source, data_dest)
    else:
        img_folder = r'/data/liyue/data/DataFountain/training_128*128_Caucasian/'
