...
class ArcFace(nn.Module):
    ...
    def __init__(self, in_features, out_features, device_id, s=64.0, m=0.50, easy_margin=False, adacos=False):
        super(ArcFace, self).__init__()
        self.in_features = in_features
        self.out_features = out_features
        # if device_id>1:
        #     self.device_id = [device_id_ for device_id_ in  range(device_id)]
        # else:
        #     self.device_id =None
        self.device_id = [device_id_ for device_id_ in range(device_id)]
        self.adacos = adacos
